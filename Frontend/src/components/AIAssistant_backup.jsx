...
const AIAssistant = () => {
  ...
  const getAIResponse = async (userMessage) => {
    ...
    if (message.includes('top products') || message.includes('best products') || message.includes('popular products') || 
      ...
      try {
        ...
        if (response.ok) {
          ...
          moveRobot(30, 60);
          return "Wow! 🌟 These are absolutely our most popular products that customers can't stop raving about! I think you'll love them too!";
        }
      } catch (error) {
      ...
      const topProducts = [
        { name: "Wireless Headphones", category: "Electronics", rating: 4.8, price: "₹2,999" },
        { name: "Smart Watch", category: "Electronics", rating: 4.7, price: "₹8,999" },
        { name: "Cotton T-Shirt", category: "Fashion", rating: 4.6, price: "₹599" },
        { name: "Running Shoes", category: "Fashion", rating: 4.9, price: "₹3,499" }
      ];
      setSuggestions(topProducts);
      setShowSuggestions(true);
      moveRobot(30, 60);
    ...
    if (message.includes('toy') || message.includes('daughter') || message.includes('son') || message.includes('gift') || 
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (toys.length > 0) {
            setSuggestions(toys);
            setShowSuggestions(true);
            return "Aww, how sweet! 🎁🧸 I just love helping find perfect gifts for little ones! I'm taking you to our children's toys category page where you can see all the amazing toys that will definitely bring huge smiles and endless joy!";
          }
        }
      } catch (error) {
      ...
      // Fallback to static data
      const toys = [
        { name: "Educational Building Blocks", category: "Toys", rating: 4.9, price: "₹1,299" },
        { name: "Interactive Doll", category: "Toys", rating: 4.6, price: "₹999" },
        { name: "Art & Craft Kit", category: "Toys", rating: 4.7, price: "₹699" },
        { name: "Musical Keyboard", category: "Toys", rating: 4.5, price: "₹1,599" }
      ];
      setSuggestions(toys);
      setShowSuggestions(true);
      return "Aww, how sweet! 🎁🧸 I just love helping find perfect gifts for little ones! I'm taking you to our children's toys category page where you can see all the amazing toys that will definitely bring huge smiles and endless joy!";
    ...
    if (message.includes('electronics') || message.includes('gadgets') || message.includes('phone') || message.includes('laptop') ||
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (electronics.length > 0) {
            ...
            setShowSuggestions(true);
            return "Ooh, tech lover! 📱💻✨ You've got excellent taste! I'm taking you to our electronics category page where you can explore all our cutting-edge gadgets and super popular tech items!";
          }
        }
      } catch (error) {
      ...
      // Fallback to static data
      const electronics = [
        { name: "Smartphone", category: "Electronics", rating: 4.8, price: "₹15,999" },
        { name: "Laptop", category: "Electronics", rating: 4.7, price: "₹45,999" },
        { name: "Bluetooth Speaker", category: "Electronics", rating: 4.6, price: "₹1,999" },
        { name: "Gaming Console", category: "Electronics", rating: 4.9, price: "₹35,999" }
      ];
      setSuggestions(electronics);
      setShowSuggestions(true);
      return "Ooh, tech lover! 📱💻✨ You've got excellent taste! I'm taking you to our electronics category page where you can explore all our cutting-edge gadgets and super popular tech items!";
    ...
    if (message.includes('search') || message.includes('find') || message.includes('looking for') || 
        message.includes('where is') || message.includes('show me') || message.includes('need') || 
        ...
        <div className="ai-chat-container">
          <div className="ai-chat-header">
            ...
            <div className="ai-info">
              ...
              <span className="ai-status">Ready to help you! ✨</span>
            </div>
